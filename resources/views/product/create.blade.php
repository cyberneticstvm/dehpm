        ...
        <div class="col-lg-12 col-md-12 mb-4">
            <div class="card">
                <div class="card-header">
                    <div class="row">
                        <div class="col">
                            <h5>Create {{ $hsn->name }}</h5>
                        </div>
                    </div>
                </div>
                <div class="card-body">
                    {{ html()->form('POST', route('product.save', encrypt($hsn->id)))->open() }}
                    <div class="row g-3">
                        <div class="col-sm-4">
                            ...
                            <div class="input-group input-group-merge">
                                ...
                                {{ html()->text('name', old('name'))->class('form-control')->placeholder('Product Name')->required() }}
                            </div>
                            @error('name')
                        ...
                        <div class="col-sm-3">
                            ...
                            {{ html()->select($name = 'hsn_id', $value = $hsns, old('hsn_id') ?? $hsn->id)->class('select2 form-select')->placeholder('Select')->required() }}
                            @error('hsn_id')
                        ...
                        <div class="col-sm-3">
                            ...
                            {{ html()->select($name = 'manufacturer_id', $value = $manufacturers, old('manufacturer_id'))->class('select2 form-select')->placeholder('Select')->required() }}
