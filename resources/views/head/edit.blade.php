        ...
        <div class="col-lg-12 col-md-12 mb-4">
            <div class="card">
                <div class="card-header">
                    <div class="row">
                        <div class="col">
                            <h5>Update Head (Income & Expense)</h5>
                        </div>
                    </div>
                </div>
                <div class="card-body">
                    ...
                    <div class="row g-3">
                        <div class="col-sm-6">
                            ...
                            <div class="input-group input-group-merge">
                                ...
                                {{ html()->text('name', $head->name)->class('form-control')->placeholder('Head Name')->required() }}
                            </div>
                            @error('name')
                        ...
                        <div class="col-sm-3">
                            ...
                            {{ html()->select($name = 'type', $value = $types, $head->type)->class('select2 form-select')->placeholder('Select')->required() }}
                            @error('roles')
