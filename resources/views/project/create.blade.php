    ...
    <div class="row">
        ...
        <div class="col-lg-12 col-md-12 mb-4">
            <div class="card">
                ...
                <div class="card-body">
                    {{ html()->form('POST', route('project.save'))->open() }}
                    <div class="row g-3">
                        <div class="col-sm-6">
                            ...
                            <div class="input-group input-group-merge">
                                ...
                                {{ html()->text('name', old('name'))->class('form-control')->placeholder('Project Name')->required() }}
                            </div>
                            @error('name')
                        ...
                        <div class="col-sm-3">
                            ...
                            <div class="input-group input-group-merge">
                                ...
                                {{ html()->text('code', old('code'))->maxlength(25)->class('form-control')->placeholder('Project Code')->required() }}
                            </div>
                            @error('code')
                        ...
                        <div class="col-sm-3">
                            ...
                            <div class="input-group input-group-merge">
                                ...
                                {{ html()->text('cost', old('cost'))->maxlength(10)->class('form-control')->placeholder('0.00')->required() }}
                            </div>
                            @error('cost')
                        ...
                        <div class="col-sm-6">
                            ...
                            <div class="input-group input-group-merge">
                                ...
                                {{ html()->textarea('details', old('details'))->class('form-control')->placeholder('Project Details') }}
                            </div>
                            @error('details')
