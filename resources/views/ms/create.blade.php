    ...
    <div class="row">
        ...
        <div class="col-lg-12 col-md-12 mb-4">
            <div class="card">
                ...
                <div class="card-body">
                    {{ html()->form('POST', route('ms.save', $type))->open() }}
                    <div class="row g-3">
                        <div class="col-sm-6">
                        ...
                        <div class="col-sm-3">
                            ...
                            <div class="input-group input-group-merge">
                                ...
                                {{ html()->text('mobile', old('mobile'))->class('form-control')->maxlength(10)->placeholder('Mobile')->required() }}
                            </div>
                            @error('mobile')
                        ...
                        <div class="col-sm-6">
                            ...
                            <div class="input-group input-group-merge">
                                ...
                                {{ html()->textarea('address', old('address'))->class('form-control')->placeholder('Address') }}
                            </div>
                            @error('address')
