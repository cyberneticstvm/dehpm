<div class="offcanvas offcanvas-end" id="edit-branch">
    <div class="offcanvas-header border-bottom">
        <h5 class="offcanvas-title" id="exampleModalLabel">Update Branch</h5>
        <button
            type="button"
    ...
    <div class="offcanvas-body flex-grow-1">
        {{ html()->form('POST')->route('branch.update')->attribute('id', 'form-edit-record')->class('add-new-record pt-0 row g-2')->open() }}
        <div class="col-sm-12">
            ...
            <div class="input-group input-group-merge">
                ...
                {{ html()->text('name', old('name'))->class('form-control editName')->placeholder('Branch Name')->required() }}
            </div>
            @error('name')
        ...
        <div class="col-sm-6">
            ...
            <div class="input-group input-group-merge">
                ...
                {{ html()->text('code', old('code'))->class('form-control editCode')->maxlength(10)->placeholder('Branch Code')->attribute('readonly', true) }}
            </div>
            @error('code')
        ...
        <div class="col-sm-6">
            ...
            <div class="input-group input-group-merge">
                ...
                {{ html()->text('mobile', old('mobile'))->class('form-control editMobile')->maxlength(10)->placeholder('0123456789')->required() }}
            </div>
            @error('mobile')
        ...
        <div class="col-sm-12">
            ...
            <div class="input-group input-group-merge">
                ...
                {{ html()->text('contact_number', old('contact_number'))->class('form-control editContact')->placeholder('Contact Number') }}
            </div>
        </div>
        <div class="col-sm-12">
            ...
            <div class="input-group input-group-merge">
                ...
                {{ html()->textarea('address', old('address'))->class('form-control editAddress')->placeholder('Address')->required() }}
            </div>
            @error('address')
