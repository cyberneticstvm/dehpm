    ...
    <div class="row">
        ...
        <div class="col-lg-12 col-md-12 mb-4">
            <div class="card">
                ...
                <div class="card-body">
                    {{ html()->form('POST', route('ie.update', ['id' => encrypt($ie->id), 'type' => $type->name]))->open() }}
                    <div class="row g-3">
                        <div class="col-sm-3">
                            <label for="selectpickerBasic" class="form-label req">Date</label>
                            {{
                                html()->date('ie_date', $ie->ie_date->format('Y-m-d'))->class('form-control')->when(Auth::user()->roles()->first()->name != 'Administrator', function($el){
                        ...
                        <div class="col-sm-6">
                            ...
                            {{ html()->select($name = 'head_id', $value = $heads, $ie->head_id)->class('select2 form-select')->placeholder('Select')->required() }}
                            @error('head_id')
                        ...
                        <div class="col-sm-3">
                            ...
                            {{ html()->text('amount', $ie->amount)->class('form-control')->placeholder('0.00')->required() }}
                            @error('amount')
                        ...
                        <div class="col-sm-6">
                            ...
                            <div class="input-group input-group-merge">
                                ...
                                {{ html()->textarea('remarks', $ie->remarks)->class('form-control')->placeholder('Notes / Remarks') }}
                            </div>
                            @error('remarks')
